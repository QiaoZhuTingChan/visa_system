...
public class Des {
	private static String DEFAULT_KEY = Environment.getEncryptionKey();
	...
	public static String get3DESEncrypt(String src) throws Exception {
		return get3DESEncrypt(src, DEFAULT_KEY);
	}
	 ...
	 * @throws Exception
	 */
	public static String get3DESEncrypt(double value) throws Exception {
		return get3DESEncrypt(String.valueOf(value));
	}
//
...
//	}
	 ...
	 * @throws Exception
	 */
	public static String deCrypt(byte[] debase64, String spKey) throws Exception {
		String strDe = null;
		Cipher cipher = null;
		try {
	...
	public static String get3DESDecrypt(String src) throws Exception {
		return get3DESDecrypt(src, DEFAULT_KEY);
	}

	public static void main(String[] args) throws Exception {
		Des test = new Des();
		String oldString = "对于 AES 等加/解密本质上不同的算法来说,这种简化是巨大的。无填充,可以高效地作为流式加密使用";
		String SPKEY = "";
